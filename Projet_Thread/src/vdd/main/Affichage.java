	...
	public void paint(Graphics g) {
		...
		if (manageur != null && manageur.listeAscenseur != null) {
			for (int i = 0; i < manageur.listeAscenseur.size(); i++) {
				...
				if (a.personneAscenseur != null && a.personneAscenseur.etat == Personne.ETAT_MOVE) {
					g.setFont(new Font("Arial", Font.PLAIN, 20));
					g.drawString(a.personneAscenseur.nom, Integer.valueOf(a.getName()).intValue() * 60 + 8, hau - Asc.HAUTEUR_ETAGE - (a.etage * Asc.HAUTEUR_ETAGE + a.progression) + 15);
				}
			}
		}
	}
